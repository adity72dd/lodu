...
# Configuration
TOKEN = '7899549372:AAGttFFA0oGUYHHzEcPFaonSJGCToQMhI0o'
...
def handle_genkey(message):
    if message.from_user.id != ADMIN_USER_ID:
        bot.reply_to(message, "𝙊𝙉𝙇𝙔 𝙊𝙒𝙉𝙀𝙍 𝘿𝙈-> https://t.me/+QTEGDStFnkI1Y2Vl")
        return
...
def handle_attack(message):
    ...
    if not user_data or user_data['plan'] == 0:
        bot.reply_to(message, "𝘿𝙈-> @NARUTO_OWNERS")
        return
